            ...
            <ul class="nav-notification clearfix">
                <li class="profile dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <strong>Picture Categories</strong>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        foreach ($categories as $category) { ?>
                            <li>
                                <a class="clearfix" href="#<?= $category->category_id ?>">
                                    <div class="detail">
                ...
                <li class="profile dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a tabindex="-1" href="<?= Url::toRoute(['/user/setting']) ?>" class="theme-setting" data-pjax="0"><i class="glyphicon glyphicon-cog"></i> <?= Yii::t('app', 'Setting') ?></a></li>
                        <li class="divider"></li>
            ...
            <div class="sidebar-inner scrollable-sidebar" style="overflow: hidden; width: auto; height: 100%;">
                ...
                <div class="main-menu">
                    <ul>
                        ...
                        <li>
                            <a href="<?= Url::toRoute('/explore/photos') ?>" data-pjax="0">
                            <span class="menu-icon">
