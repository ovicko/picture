        ...
        <div class="container">
            ...
            <div class="row" style="margin-top: 15px;">
              <?= Nav::widget([
                'encodeLabels' => false,
                'items' => [
                  ['label' => Yii::t('app', 'Profile'), 'url' => ['setting/profile'], 'linkOptions' => ['data-pjax' => 0]],
                  ['label' => Yii::t('app', 'Account'), 'url' => ['setting/account']],
                  ['label' => Yii::t('app', 'Security'), 'url' => ['setting/security']],
                ],
